 ...
 */
@Entity
@Table(name = "HABITATIONS", catalog = "", schema = "MARCEL")
@XmlRootElement
@NamedQueries({
...
public class Habitations implements Serializable {
    ...
    public String toString() {
        return "com.chauffe.fonctions.Habitations[ habitationId=" + habitationId + " ]";
    }
